                    ...
                    <thead>
                      ...
                      <tbody>
                        <tr>
                          <td className="px-5 py-4 border-b border-gray-200 bg-white text-sm">
                            <div className="flex items-center">
                              <div className="flex-shrink-0">
                                ...
                                <img alt="Photo" src='https://play-lh.googleusercontent.com/zBd7Q4x1OcQbBubjxwrCYzj2bJx8-tpF045EkxWgSDzQ33wOLhoqiHJp0ovSzTdCI54=w240-h480-rw' className="mx-auto object-cover rounded-full h-10 w-10 " />
                                </a>
                              </div>
                              <div className="ml-3">
                          ...
                          <td className="px-5 py-4 border-b border-gray-200 bg-white text-sm">
                            <button className="text-dark-purple hover:t ext-blue-900">
                              Chatear
                            </button>
                          </td>
                        </tr>
